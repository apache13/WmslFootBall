...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post prizes_url, params: { prize: { code: @prize.code, name: @prize.name, price: @prize.price } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { code: @prize.code, name: @prize.name, price: @prize.price } }
