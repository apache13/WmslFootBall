...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { code: @sponsor.code, enable: @sponsor.enable, end: @sponsor.end, group: @sponsor.group, name: @sponsor.name, start: @sponsor.start, url: @sponsor.url } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { code: @sponsor.code, enable: @sponsor.enable, end: @sponsor.end, group: @sponsor.group, name: @sponsor.name, start: @sponsor.start, url: @sponsor.url } }
