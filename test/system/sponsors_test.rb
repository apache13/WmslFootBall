...
class SponsorsTest < ApplicationSystemTestCase
  ...
  test "creating a Sponsor" do
    ...
    fill_in "Code", with: @sponsor.code
    fill_in "Enable", with: @sponsor.enable
    fill_in "End", with: @sponsor.end
    fill_in "Group", with: @sponsor.group
    fill_in "Name", with: @sponsor.name
    fill_in "Start", with: @sponsor.start
    fill_in "Url", with: @sponsor.url
